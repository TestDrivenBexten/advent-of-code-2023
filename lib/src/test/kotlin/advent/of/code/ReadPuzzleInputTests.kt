...
class ReadPuzzleInputTests {
    ...
    fun should_read_hello_world_for_string_list(){
        val path = Paths.get("src/test/kotlin/advent/of/code/string.txt")
    ...
    fun should_read_integer_list(){
        val path = Paths.get("src/test/kotlin/advent/of/code/integer.txt")
    ...
    fun should_read_long_list(){
        val path = Paths.get("src/test/kotlin/advent/of/code/long.txt")
